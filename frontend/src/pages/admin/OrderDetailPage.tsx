...
const IconPerson = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <circle cx="8" cy="5" r="3" stroke="#C9A84C" strokeWidth="1.1" fill="none" opacity="0.6" />
    <path d="M2 14c0-3.3 2.7-6 6-6s6 2.7 6 6" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round" fill="none" opacity="0.6" />
  </svg>
);
const IconBox = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M2 5l6-3 6 3v6l-6 3-6-3V5z" stroke="#C9A84C" strokeWidth="1.1" fill="none" opacity="0.6" />
    <path d="M8 2v12M2 5l6 3 6-3" stroke="#C9A84C" strokeWidth="1.1" fill="none" opacity="0.6" />
  </svg>
);
const IconHistory = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <circle cx="8" cy="8" r="6" stroke="#C9A84C" strokeWidth="1.1" fill="none" opacity="0.6" />
    <path d="M8 5v3.5l2 2" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round" opacity="0.6" />
  </svg>
);
const IconAI = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M8 1l1.5 4.5L14 7l-4.5 1.5L8 13l-1.5-4.5L2 7l4.5-1.5z" stroke="#F0C040" strokeWidth="1.1" fill="rgba(240,192,64,0.10)" opacity="0.9" />
  </svg>
);
  ...
  return (
    <div className="greek-bg">
      <div className="greek-page">
        ...
        {/* ── Customer info ── */}
        <Section title="Customer Information" icon={<IconPerson />} delay={0}>
        ...
        {/* ── Order summary ── */}
        <Section title="Order Summary" icon={<IconBox />} delay={80}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>

            <div>
              <p style={FL}>Total Amount</p>
              <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 24, fontWeight: 600, color: '#F0C040', letterSpacing: '-0.01em', lineHeight: 1 }}>
            ...
            {order.driver_note && (
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <div style={{ padding: '10px 14px', background: 'rgba(201,168,76,0.06)', borderLeft: '2px solid rgba(201,168,76,0.40)', borderRadius: '0 2px 2px 0' }}>
                  <p style={{ ...FV, fontStyle: 'italic', color: 'rgba(232,213,163,0.75)' }}>{order.driver_note}</p>
                </div>
              </div>
            )}
          </div>
        ...
        {/* ── Event history ── */}
        <Section title="Event History" icon={<IconHistory />} delay={160}>
          <div style={{ padding: '20px 0', textAlign: 'center' }}>
            <p className="greek-muted" style={{ fontStyle: 'italic', marginBottom: 6 }}>
              Event history is not yet available.
            </p>
            <code style={{ fontFamily: "'Inter', monospace", fontSize: 11, color: 'rgba(201,168,76,0.40)', background: 'rgba(201,168,76,0.06)', padding: '2px 8px', borderRadius: 2 }}>
